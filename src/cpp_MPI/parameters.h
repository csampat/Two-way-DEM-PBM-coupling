...
//TUNING PARAMETERS
#define AGGREGATIONKERNELCONSTANT 1.0e-16//4.375e-7//3.75488281e-9//1.0//9.375e-4//1.0e-6 //1.0e-3 //240.0
...
#define BREAKAGEKERNELCONSTANT 1.0e-9 //5.0
#define BREAKAGEPROBABILITY 0.15
#define CONSOLIDATIONCONSTANT 1.0e-16
...
#define LIQUIDADDITIONTIME 5.0//105.0//75.0//45.0
