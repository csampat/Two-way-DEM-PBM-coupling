...
//TUNING PARAMETERS
#define AGGREGATIONKERNELCONSTANT 8.0e-14 //8.0e-14 //5.0e-14//1e-12//3.75488281e-9//1.0//9.375e-4//1.0e-6 //1.0e-3 //240.0
...
#define CONSOLIDATIONCONSTANT 1e-25 //1.0e-25//1.0e-16
...
#define PREMIXINGTIME 15.00//10.0//5.00//45.0                             //0.0 // seconds
#define LIQUIDADDITIONTIME 35.0//25.0//105.0//75.0//45.0
